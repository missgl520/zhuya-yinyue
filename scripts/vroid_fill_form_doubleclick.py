...
# name field
pyautogui.doubleClick(1400, 780)
time.sleep(0.3)
pyautogui.typewrite("""Ren""", interval=0.01)
time.sleep(0.3)

# author field
pyautogui.doubleClick(1400, 1000)
time.sleep(0.3)
pyautogui.typewrite("""zhuyapp""", interval=0.01)
time.sleep(0.3)

img = pyautogui.screenshot()
img.save(r'F:/zhuyapp/_vroid_form_filled_check.png')
